...
namespace Stripeofficial\BANCONTACT\Observer;
...
use Stripeofficial\BANCONTACT\Model\Ui\ConfigProvider;
...
class DataAssignAfterSuccessObserver implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if ($order->getData('stripe_source_id')) {
            ...
            $message = 'Authorized amount of %1. Awaiting payment confirmation. Please hold the shipment until order status is processing';
